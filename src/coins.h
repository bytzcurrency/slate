...
/** 
    ...
    ****Note - for SLATE we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of slate coming in to a transaction
