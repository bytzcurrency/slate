...
{
public:
    /// Is the inputs associated with this public key? (and there is 350000 SLX - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of slate.
