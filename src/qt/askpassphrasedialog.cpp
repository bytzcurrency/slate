                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zSLX || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending SLX because you wouldn't check it anyway.
    if (context == Context::Send_SLX || context == Context::Send_zSLX) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR SLX</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("SLATE will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your SLXs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
