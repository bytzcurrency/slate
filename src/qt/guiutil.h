...
/** Utility functions used by the SLATE Qt UI.
 */
namespace GUIUtil
{
...
// Render SLATE addresses in monospace font
...
// Parse "slate:" URI into recipient object, return true on successful parsing
