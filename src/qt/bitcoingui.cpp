                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SLATE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SLATE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slate: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSLX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SLATE Core"), this);
    aboutAction->setStatusTip(tr("Show information about SLATE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SLATE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SLATE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SLATE addresses"));
    ...
    openAction->setStatusTip(tr("Open a SLATE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SLATE Core help message to get a list with possible SLATE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SLATE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SLATE network", "", count));
}
...
{
    QString strTitle = tr("SLATE Core"); // default title
