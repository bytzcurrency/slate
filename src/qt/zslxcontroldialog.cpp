...
std::set<std::string> ZSlxControlDialog::setSelectedMints;
...
void ZSlxControlDialog::updateLabels()
{
    ...
    privacyDialog->setZSlxControlLabels(nAmount, setSelectedMints.size());
}

std::vector<CMintMeta> ZSlxControlDialog::GetSelectedMints()
{
