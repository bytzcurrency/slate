                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSLXPathCustom = GetArg("-zslxbackuppath", "");
    ...
    if(!strzSLXPathCustom.empty()) {
        ui->wallet_customzslxbackuppath->setText(QString::fromStdString(strzSLXPathCustom));
        ui->wallet_customzslxbackuppath_label->setVisible(true);
        ui->wallet_customzslxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSLXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SLATE RPC console.") + "<br>" +
