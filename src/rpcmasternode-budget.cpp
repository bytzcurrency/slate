...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a SLATE initiative\n"
            "  vote-alias         - Vote on a SLATE initiative\n"
            "  vote               - Vote on a SLATE initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"slate-address\" monthy-payment\n"
            ...
            "5. \"slate-address\":   (string, required) SLATE address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.slate.org/t/test-proposal\" 2 820800 \"se9SRHBXWThEqrTDqEHy7eBZpTyLhQqZHs\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.slate.org/t/test-proposal\" 2 820800 \"se9SRHBXWThEqrTDqEHy7eBZpTyLhQqZHs\" 500"));
    ...
    CWalletTx wtx;
    if (!pwalletMain->GetBudgetSystemCollateralTX(wtx, budgetProposalBroadcast.GetHash(), useIX)) { // 50 SLX collateral for proposal
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"slate-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.slate.org/t/test-proposal\" 2 820800 \"se9SRHBXWThEqrTDqEHy7eBZpTyLhQqZHs\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.slate.org/t/test-proposal\" 2 820800 \"se9SRHBXWThEqrTDqEHy7eBZpTyLhQqZHs\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) SLATE address of payment\n"
