...
#ifndef SLATE_ZSLXWALLET_H
#define SLATE_ZSLXWALLET_H
...
public:
    CzSLXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSLX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSLX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //SLATE_ZSLXWALLET_H
