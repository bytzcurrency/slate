...
RESOURCES += src/qt/slate.qrc src/qt/slate_locale.qrc

TRANSLATIONS += src/qt/locale/slate_bg.ts \
                src/qt/locale/slate_de.ts \
                src/qt/locale/slate_en.ts \
                src/qt/locale/slate_es.ts \
                src/qt/locale/slate_fi.ts \
                src/qt/locale/slate_fr.ts \
                src/qt/locale/slate_it.ts \
                src/qt/locale/slate_ja.ts \
                src/qt/locale/slate_pl.ts \
                src/qt/locale/slate_pt.ts \
                src/qt/locale/slate_ru.ts \
                src/qt/locale/slate_sk.ts \
                src/qt/locale/slate_sv.ts \
                src/qt/locale/slate_vi.ts \
                src/qt/locale/slate_zh_CN.ts \
                src/qt/locale/slate_zh_TW.ts
