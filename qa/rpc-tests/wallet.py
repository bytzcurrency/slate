...
#   c) node1 mines 32 blocks, so now node 0 has 60001slx, node 1 has 4250slx, node2 has none.
#   d) node0 sends 601 slx to node2, in two transactions (301 slx, then 300 slx).
