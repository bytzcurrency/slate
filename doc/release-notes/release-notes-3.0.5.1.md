We have found that a runtime error that has caused the SLATE wallet on certain operating systems to get stuck at block 908000. This build of the wallet fixes the runtime error.
