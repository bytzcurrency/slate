...
In order to support loading of multiple wallets in slate-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is slate.cpp.
...
Changes to slate.cpp
----------------------
slate.cpp is the entry point into slate-qt, and as such, will require some minor modifications to provide hooks for
